      ...
      <div className="account__wrapper">
        <div className="account__card">
          <div className="account__profile">
            ...
            <p className="account__name">Seja bem vindo ao editor!</p>
            <p className="account__sub">Insira seu nome para entar e editar o documento</p>
          </div>
    ...
    return (
      <React.Fragment>
        <Navbar color="light" light>
          <NavbarBrand href="/">Editor de documentos em tempo real</NavbarBrand>
        </Navbar>
